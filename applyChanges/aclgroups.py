...
#Acl groups user doc
command1  = 'sed \''+str(squid1)+','+str(squid2)+' !d\' /root/freeBSD_Files/applyChanges/config.xml > /root/freeBSD_Files/applyChanges/aclgroupsUser.xml'
os.system(command1)
...
commandA1  = 'sed \''+str(squidA)+','+str(squidA1)+' !d\' /root/freeBSD_Files/applyChanges/conf.xml > /root/freeBSD_Files/applyChanges/aclgroupsAdmin.xml'
os.system(commandA1)
#####End admin section#####

####Start merge Section####
commandMix1 = 'cat /root/freeBSD_Files/applyChanges/aclgroupsUser.xml /root/freeBSD_Files/applyChanges/aclgroupsAdmin.xml > /root/freeBSD_Files/applyChanges/finalAclgroups.xml'
commandremoveU1 = 'rm -r -f /root/freeBSD_Files/applyChanges/aclgroupsUser.xml'
commandremoveA1 = 'rm -r -f /root/freeBSD_Files/applyChanges/aclgroupsAdmin.xml'
...
commandsq1  = 'sed \''+str(squidg)+','+str(squidg1)+' !d\' /root/freeBSD_Files/applyChanges/config.xml > /root/freeBSD_Files/applyChanges/beforeAclgroups.xml'
...
commandMixsq1 = 'cat /root/freeBSD_Files/applyChanges/beforeAclgroups.xml /root/freeBSD_Files/applyChanges/finalAclgroups.xml > /root/freeBSD_Files/applyChanges/finalsq1.xml'
commandremovesq1 = 'rm -r -f /root/freeBSD_Files/applyChanges/beforeAclgroups.xml'
commandremovesqg1 = 'rm -r -f /root/freeBSD_Files/applyChanges/finalAclgroups.xml'
